...
<head>
    ...
    <script type="text/javascript"
            src="http://maps.google.com/maps/api/js?sensor=false&key=AIzaSyD77UkTG_J8TBzvJVCxfQTP1vp2I6uYkC0&libraries=places">
    </script>
...
<header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url('owner')?>" class="logo">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php if ($ktp!=""){echo base_url('uploads/owner/');echo$ktp;}else{echo base_url('assets/back/dist/img/user2-160x160.jpg');}?>" class="user-image" alt="User Image">
                        <span class="hidden-xs"><?php echo $this->session->userdata('namaOwn');?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="<?php if ($ktp!=""){echo base_url('uploads/owner/');echo$ktp;}else{echo base_url('assets/back/dist/img/user2-160x160.jpg');}?>" class="img-circle" alt="User Image">
                            <p>
                                <?php echo $this->session->userdata('namaOwn'); echo " - "; echo $this->session->userdata('emailOwn')?>
                                <small><?php echo $this->session->userdata('userOwn')?></small>
                            </p>
                        </li>
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo base_url('profile/owner');?>" class="btn btn-default btn-flat">Profile</a>
                            </div>
                            <div class="pull-right">
                                <a href="<?php echo base_url('logout/owner')?>" class="btn btn-default btn-flat">Sign out</a>
                            </div>
                        </li>
                    </ul>
                </li>
