                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <div class="has-feedback">
                                <a href="<?php  echo base_url('C_backOwner/manageLoc/'.$owner)?>"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></button></a>
                            </div>
                        </div>
                        <!-- /.box-tools -->
                    </div>
                    ...
                    <div class="box-body no-padding">
                        <div class="table-responsive mailbox-messages">
                            <table id="owner" class="table table-hover table-striped">
                                ...
                                <tbody>
                                <?php
                                foreach ($dataWisata as $a){
                                    ?>
                                    <script>var url = "<?php  echo base_url('C_backOwner/setDeleteWisata/');echo $a->id_wisata."/".$owner;?>";</script>
                                    ...
                                    <tr>
                                        <td class="btn-group">
                                            ...
                                            <a href="<?php  echo base_url('C_backOwner/setEditWisata/');echo $a->id_wisata."/".$owner;?>">
                                        ...
                                        <td class=""><?php echo $a->id_wisata;?></td>
                                        <td class=""><?php echo $a->nama_tempat;?></td>
                                        <td class=""><?php echo $a->alamat;?></td>
