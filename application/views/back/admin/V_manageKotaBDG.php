                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <div class="has-feedback">
                                <a href="<?php  echo base_url('manage/kotaBDG')?>"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></button></a>
                            </div>
                        </div>
                        <!-- /.box-tools -->
                    </div>
                    ...
                    <div class="box-body no-padding">
                        <div class="table-responsive mailbox-messages">
                            <table id="owner" class="table table-hover table-striped">
                                ...
                                <tbody>
                                <?php
                                foreach ($dataBdg as $a){
                                    ?>
                                    <script>var url = "<?php  echo base_url('C_backAdmin/setDeleteWisataBdg/');echo $a->id_wisata;?>";</script>
                                    ...
                                    <tr>
                                        <td class="btn-group">
                                            ...
                                            <a href="<?php  echo base_url('C_backAdmin/setEditWisataKotaBdg/');echo $a->id_wisata;?>">
